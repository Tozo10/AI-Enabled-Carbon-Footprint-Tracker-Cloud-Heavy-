...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "http://localhost:3000", # Just in case you switch ports later
    "http://localhost:80",   # If accessing via Docker default port
]

# (Optional) If you face cookie/session issues, set this to True
